...
void JKFF::Calculate(){
	...
	//printf("%d , %d \n", tC, this->prevC);
	if (tC == 0 && curr == 1){
		if (db[this->ins[0].CenterPoint().x / 10][this->ins[0].CenterPoint().y / 10] == 1 && db[this->ins[1].CenterPoint().x / 10][this->ins[1].CenterPoint().y / 10] == 1){
			db[this->outs[0].CenterPoint().x / 10][this->outs[0].CenterPoint().y / 10] ^= 1;
			db[this->outs[1].CenterPoint().x / 10][this->outs[1].CenterPoint().y / 10] = 1 ^ db[this->outs[0].CenterPoint().x / 10][this->outs[0].CenterPoint().y / 10];
		}
		else if (db[this->ins[0].CenterPoint().x / 10][this->ins[0].CenterPoint().y / 10] == 1){
			db[this->outs[0].CenterPoint().x / 10][this->outs[0].CenterPoint().y / 10] = 1;
