...
public:
	...
	void Calculate() override{
		...
		if (db[this->in1.CenterPoint().x / 10][this->in1.CenterPoint().y / 10] == 0 && db[this->in2.CenterPoint().x / 10][this->in2.CenterPoint().y / 10] == 0){
		...
		else if (db[this->in1.CenterPoint().x / 10][this->in1.CenterPoint().y / 10] == 0 && db[this->in2.CenterPoint().x / 10][this->in2.CenterPoint().y / 10] == 1){
			db[this->out.CenterPoint().x / 10][this->out.CenterPoint().y / 10] = 1;
		}
		else if (db[this->in1.CenterPoint().x / 10][this->in1.CenterPoint().y / 10] == 1 && db[this->in2.CenterPoint().x / 10][this->in2.CenterPoint().y / 10] == 0){
			db[this->out.CenterPoint().x / 10][this->out.CenterPoint().y / 10] = 1;
		}
		else{
			db[this->out.CenterPoint().x / 10][this->out.CenterPoint().y / 10] = -1;
